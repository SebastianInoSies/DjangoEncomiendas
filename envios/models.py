...
class Encomienda(models.Model):
    ...
    volumen_cm3 = models.DecimalField(max_digits=12, decimal_places=2,
    ...
    ruta = models.ForeignKey(
        'rutas.Ruta', on_delete=models.PROTECT,
    ...
    def crear_con_costo_calculado(cls, remitente, destinatario, ruta,
        ...
        fecha_est = timezone.now().date() + timezone.timedelta(days=ruta.dias_entrega)
        encomienda = cls(
            codigo=codigo,
